...
def perception_step(Rover):
    ...
    borders = color_thresh(transformed,(0,0,0))-color_thresh(transformed)-rock
    ...
    xpix_obs, ypix_obs = rover_coords(borders)
    xpix_rock, ypix_rock = rover_coords(rock)
    xpix_ground, ypix_ground = rover_coords(ground)
    ...
    Rover.worldmap[obstacle_y_world, obstacle_x_world] = (255,0,0)
    Rover.worldmap[rock_y_world, rock_x_world] = (0,255,0)
